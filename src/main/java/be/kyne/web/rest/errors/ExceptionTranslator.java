package be.kyne.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(be.kyne.service.EmailAlreadyUsedException ex, NativeWebRequest request) {
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        be.kyne.service.UsernameAlreadyUsedException ex,
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleInvalidPasswordException(be.kyne.service.InvalidPasswordException ex, NativeWebRequest request) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "be.kyne");
    }
}
