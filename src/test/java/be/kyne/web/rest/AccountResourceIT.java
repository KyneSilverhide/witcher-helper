...
import static be.kyne.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import be.kyne.IntegrationTest;
import be.kyne.config.Constants;
import be.kyne.domain.User;
import be.kyne.repository.AuthorityRepository;
import be.kyne.repository.UserRepository;
import be.kyne.security.AuthoritiesConstants;
import be.kyne.service.UserService;
import be.kyne.service.dto.AdminUserDTO;
import be.kyne.service.dto.PasswordChangeDTO;
import be.kyne.service.dto.UserDTO;
import be.kyne.web.rest.vm.KeyAndPasswordVM;
import be.kyne.web.rest.vm.ManagedUserVM;
