...
import be.kyne.repository.CampaignRepository;
import be.kyne.service.dto.CampaignDTO;
import be.kyne.service.mapper.CampaignMapper;
...
class CampaignResourceIT {
    ...
    public static Campaign createEntity(EntityManager em) {
        Campaign campaign = new Campaign().name(DEFAULT_NAME);
        return campaign;
    }
    ...
    public static Campaign createUpdatedEntity(EntityManager em) {
        Campaign campaign = new Campaign().name(UPDATED_NAME);
        return campaign;
    }
    ...
    void putNewCampaign() throws Exception {
        ...
        updatedCampaign.name(UPDATED_NAME);
